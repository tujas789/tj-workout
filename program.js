...
const PROGRAM = {
  ...
  /* ── สัปดาห์ ── วันทดสอบ = วันแบด ของหนักอยู่ต้นสัปดาห์ให้ไกลที่สุด ── */
  week: [
    { dow:1, key:'homeB', label:'บ้าน B — เครื่องยนต์ + เข่า/ข้อเท้า', mins:39 },
    { dow:2, key:'gym',   label:'ยิม — โหลดหนัก',                      mins:50 },
    { dow:3, key:'easy',  label:'ปั่นเบา',                             mins:20 },
    { dow:4, key:'homeA', label:'บ้าน A — ส่วนบน + ข้อศอก/ไหล่',        mins:31 },
    { dow:5, key:'easy',  label:'ปั่นเบา',                             mins:20 },
    { dow:6, key:'test',  label:'วันทดสอบ — แบดมินตัน',                 mins:null },
    { dow:0, key:'rest',  label:'พัก',                                 mins:0 }
  ],

  /* ── ลำดับความสำคัญเวลาทำไม่ครบ (Q31) ── */
